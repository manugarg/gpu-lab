...
sitting idle. ([Efficient GEMM in CUDA][gemm] is the canonical write-up
of the tiling that makes this work.)

[gemm]: https://docs.nvidia.com/cutlass/latest/media/docs/cpp/efficient_gemm.html
