...
Not yet done: work out actual VRAM footprint vs. the AWQ/GPTQ int4 option
(mixed FP8/FP4 will be larger than uniform int4) and run both through
`report.py` for a real comparison.
...
- VRAM footprint: AWQ/GPTQ int4 (uniform) vs. Unsloth NVFP4 (mixed FP8/FP4)
  — not yet measured.
